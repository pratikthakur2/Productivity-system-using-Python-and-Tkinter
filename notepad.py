...
def notes_func():
    sg.ChangeLookAndFeel('Purple') # change style
    ...
    def about_me():
        '''A short, pithy quote'''
        sg.popup_no_wait('"It is a simple writing pad where you and note down your thought Save it and later can Open it .')
